...
$notificationQuery =  "INSERT INTO `notifications` (`user_id`, `content`) VALUES ('$to_id', 'A file with name \"{$fileObject->filename}\" has been arrived from \"{$fromUserObject->name}\" with note: \"$note\".');";
